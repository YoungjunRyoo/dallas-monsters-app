...
Player season statistics are updated using Firestore atomic `increment()` operations.
...
The app uses Firebase Authentication for user identity, while database authorization should also be enforced through **Firestore Security Rules**.
